...
List<MyProductModel> myProductModel = [
  ...
  // for biryani
  MyProductModel(
    image: 'assets/biryani/biryani1.png',
  ...
  MyProductModel(
    image: 'assets/biryani/biryani2.png',
    name: 'Dum Biryani',
    price: 20.0,
    distance: 500,
    rate: 4.5,
  ...
  MyProductModel(
    image: 'assets/biryani/biryani3.png',
    name: 'veg Biryani',
    price: 12.0,
    distance: 500,
    rate: 4.5,
